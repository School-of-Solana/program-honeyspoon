...
test.describe('Blind Spot Tests - Uncovered Scenarios', () => {
  ...
  test.describe('Network & Connectivity', () => {
    ...
    test('Slow Network Simulation', async ({ page }) => {
      ...
      const hudVisible = await page.locator('button:has-text("DIVE DEEPER")').isVisible();
  ...
  test.describe('Session & State Management', () => {
    ...
    test('Page Refresh During Active Game', async ({ page }) => {
      ...
      const treasureBefore = await page.locator('div').filter({ hasText: /^\$\d+$/ }).first().textContent();
  ...
  test.describe('Animation & Interaction Edge Cases', () => {
    ...
    test('Click During Animation', async ({ page }) => {
      ...
      console.log('  Surface button also disabled:', surfaceDisabled ? '✅' : '⚠️');
  ...
  test.describe('Mathematical Correctness', () => {
    ...
    test('Verify EV Calculation', async ({ page }) => {
      ...
      const survivalText = await page.locator('div').filter({ hasText: /SURVIVAL/ }).locator('..').textContent();
    ...
    test('Treasure Multiplication Accuracy', async ({ page }) => {
      ...
      const multiplierText = await page.locator('text=MULTIPLIER').first().locator('..').textContent();
  ...
  test.describe('Accessibility', () => {
    ...
    test('Keyboard Navigation', async ({ page }) => {
      ...
      const isFocused = await betInput.evaluate(el => el === document.activeElement);
    ...
    test('Screen Reader Labels', async ({ page }) => {
      ...
      console.log('  Bet input has label:', hasLabel ? '✅' : '⚠️  (should add aria-label)');
