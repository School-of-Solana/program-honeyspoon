...
export function WalletManager() {
  ...
  const [gameWalletData, setGameWalletData] = useState<UserAccountData | null>(null);
            ...
            <>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <div
                  ...
                  style={{ marginBottom: '8px', backgroundColor: 'rgba(76, 175, 80, 0.1)' }}
                >
                  <div style={{ marginBottom: '4px', fontSize: '8px', opacity: 0.7 }}>
                    Solana Wallet
                  </div>
                  <div
                    style={{
              ...
              <div style={{ marginBottom: '12px' }}>
                <label style={{ fontSize: '8px', opacity: 0.7, display: 'block', marginBottom: '4px' }}>
                  Amount (SOL):
                </label>
                <input
                  type="number"
              ...
              <button
                ...
                style={{ fontSize: '10px', padding: '12px', marginBottom: '12px' }}
              >
                {isProcessing 
                  ? 'PROCESSING...' 
                  : mode === 'deposit'
              ...
              {gameWalletData && (
                ...
                >
                  <div style={{ marginBottom: '6px', fontSize: '8px', fontWeight: 'bold' }}>
                    📊 STATISTICS
                  </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px' }}>
                    <div>
                      ...
                      <div style={{ fontWeight: 'bold' }}>{gameWalletData.totalDeposited.toFixed(2)} SOL</div>
                    </div>
                    <div>
                      <div style={{ opacity: 0.6 }}>Withdrawn:</div>
                      <div style={{ fontWeight: 'bold' }}>{gameWalletData.totalWithdrawn.toFixed(2)} SOL</div>
                    </div>
                    <div>
                      <div style={{ opacity: 0.6 }}>Wagered:</div>
                      <div style={{ fontWeight: 'bold' }}>{gameWalletData.totalWagered.toFixed(2)} SOL</div>
                    </div>
                    <div>
                      <div style={{ opacity: 0.6 }}>Won:</div>
                      <div style={{ fontWeight: 'bold' }}>{gameWalletData.totalWon.toFixed(2)} SOL</div>
                    </div>
                  </div>
                  ...
                  <div style={{ marginTop: '8px', paddingTop: '8px', borderTop: '1px solid rgba(255,255,255,0.2)' }}>
                    ...
                    <div
                      style={{
                        fontSize: '16px',
                        fontWeight: 'bold',
                        color: isProfit ? GAME_COLORS.SUCCESS : GAME_COLORS.DANGER,
                      }}
                    >
                      {isProfit ? '+' : ''}{netProfit.toFixed(4)} SOL {isProfit ? '✅' : '❌'}
                    </div>
                  </div>
