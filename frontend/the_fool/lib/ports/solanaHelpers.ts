...
export const DISCRIMINATORS = {
  ...
  START_SESSION: Buffer.from([70, 252, 178, 51, 144, 187, 207, 172]),
  PLAY_ROUND: Buffer.from([93, 141, 99, 124, 155, 193, 178, 251]),
  CASH_OUT: Buffer.from([1, 110, 57, 58, 159, 157, 243, 192]),
  LOSE_SESSION: Buffer.from([178, 224, 155, 69, 119, 125, 95, 222]),
  TOGGLE_HOUSE_LOCK: Buffer.from([238, 41, 164, 80, 142, 156, 205, 141]),
};
